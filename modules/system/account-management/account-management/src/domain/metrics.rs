...
/// (`scope` label distinguishes whole-tree from future subtree-rotation
/// modes; v1 emits only `scope = "whole"`). Drives capacity-planning
/// alerts ("p95 > 60s for whole-tree"), distinct from
