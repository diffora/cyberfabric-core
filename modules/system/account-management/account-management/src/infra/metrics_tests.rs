...
use crate::domain::ports::metrics::{
    ...
    DependencyMetricsPort, DependencyOp, DependencyOutcome, DependencyTarget,
    HierarchyDepthMode, HierarchyDepthOutcome, IntegrityMetricsPort, IntegrityPhase,
    IntegrityRunOutcome, TenantMetricsPort, TenantRetentionJob, TenantRetentionOutcome,
};
use crate::domain::tenant::integrity::IntegrityCategory;
use crate::infra::metrics::AmMetricsMeter;

use account_management_sdk::idp::ProvisionFailure;
...
fn bootstrap_lifecycle_counter_routes_classification_label() {
    ...
    let pf = ProvisionFailure::Ambiguous { detail: String::new() };
    m.bootstrap_lifecycle(
        BootstrapPhase::RootCreating,
        BootstrapOutcome::Failure,
...
fn hierarchy_depth_exceedance_renders_threshold() {
    ...
    m.hierarchy_depth_exceedance(HierarchyDepthMode::Strict, HierarchyDepthOutcome::Reject, 16);
