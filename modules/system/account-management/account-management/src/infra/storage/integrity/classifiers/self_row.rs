...
//! [`IntegrityCategory::MissingClosureSelfRow`] for any in-scope tenant
//! whose self-row is absent.
//!
...
mod tests {
    ...
    #[test]
    fn out_of_scope_tenants_are_not_reported() {
        let snap = Snapshot::new(
            ...
            vec![c(1, 1), c(2, 2), c(1, 2)], // tenant 3 missing self-row but out of scope
        );
